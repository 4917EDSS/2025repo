...
public class VisionSub extends SubsystemBase {
  ...
  public Rotation2d getTargetAngle(Pose2d targetPos) {
    double targetRot = Math.toDegrees(Math.atan(targetPos.getY() / targetPos.getX()));
    return new Rotation2d(targetRot);
  }
