 ...
 */
public class TestMotorCmdAltTwo extends Command {
  ...
  public TestMotorCmdAltTwo(TestMotorParameters parameters, TestableSubsystem subsystem, TestManager testManager) {
  ...
  public void end(boolean interrupted) {
    ...
    TestResult ampsResult = m_test.addResult("Amps", currentAmps, 
        m_parameters.kAmpsTarget,
        m_parameters.kAmpsTolerance,
        m_parameters.kAmpsMin);
    ...
    TestResult positionResult = m_test.addResult("Position", currentPosition,
        m_parameters.kPositionTarget,
        m_parameters.kPositionTolerance,
        m_parameters.kPositionMin);
