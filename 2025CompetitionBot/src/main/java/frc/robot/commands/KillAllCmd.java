...
public class KillAllCmd extends Command {
  ...
  public KillAllCmd(ClimbSub climbSub, CommandSwerveDrivetrain drivetrainSub, ElevatorSub elevatorSub,
      IntakeSub intakeSub) {
    addRequirements(climbSub, drivetrainSub, elevatorSub, intakeSub);
  }
